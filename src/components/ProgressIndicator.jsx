...
export const SECTIONS = [
  ...
  { index: 3,  id: 'section-story',        label: 'STORY'        },
  { index: 4,  id: 'section-timeline',     label: 'TIMELINE'     },
  { index: 5,  id: 'section-memories',     label: 'MEMORIES'     },
  { index: 6,  id: 'section-little-things',label: 'LITTLE THINGS'},
  { index: 7,  id: 'section-reflection',   label: 'REFLECTION'   },
  { index: 8,  id: 'section-realization',  label: 'REALIZATION'  },
  { index: 9,  id: 'section-growth',       label: 'GROWTH'       },
  { index: 10, id: 'section-feelings',     label: 'FEELINGS'     },
  { index: 11, id: 'section-future',       label: 'FUTURE'       },
  { index: 12, id: 'section-choice',       label: 'CHOICE'       },
  { index: 13, id: 'section-letter',       label: 'LETTER'       },
